...
<template>
  ...
  >
    <section class="rounded-[1.5rem] border border-neutral-200/85 bg-white/78 p-3 shadow-[0_16px_40px_rgba(15,23,42,0.05)] backdrop-blur-xl dark:border-neutral-800/90 dark:bg-neutral-950/78 dark:shadow-[0_18px_42px_rgba(0,0,0,0.2)]">
      ...
      <nav
        aria-label="文章目录"
        class="max-h-[calc(100vh-9rem)] overflow-y-auto pr-1 toc-scroll"
      >
